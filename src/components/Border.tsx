    ...
    return (
        <Component
            className={clsx(
                ...
                invert
                    ? 'before:bg-white dark:before:bg-black after:bg-white/10 dark:after:bg-black/10'
                    : 'before:bg-neutral-950 dark:before:bg-neutral-200 after:bg-neutral-950/10 dark:after:bg-neutral-200/10',
                position === 'top' &&
